...
**You can assume that these paths are potentially available to you in all of the other examples listed below this one.** 
...
### How?
While you can eventually get an interactive shell on the node like in the cases above, you start with non-interactive command execution as root and you'll have to upgrade it if you want interactive access. The privesc paths are the same as above.
